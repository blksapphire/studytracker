...
object UseCaseModule {
    @Provides
    fun provideCalculateStreakUseCase(): CalculateStreakUseCase = CalculateStreakUseCase()

    @Provides
    fun provideCalculateAdaptiveGoalUseCase(): CalculateAdaptiveGoalUseCase = CalculateAdaptiveGoalUseCase()
}
